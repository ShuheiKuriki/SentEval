...
def RVSML_OT_Learning_opw(trainset,templatenum,lambda0,options,logname):
    # delta = 1
    # lambda1 = 50
    # lambda2 = 0.1
    # max_nIter = 200
...
def RVSML_OT_Learning_dtw(trainset,trainsetnum,dim,templatenum,lambda0,options,logname):
    # delta = 1
    # lambda1 = 50
    # lambda2 = 0.1
    # max_nIter = 200
